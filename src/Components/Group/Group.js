        ...
        <div ref={ref} className={"class_stammering_container class_effect_opacity" + ((inView) ? " class_effect_display" : "")}>
            ...
            <div className="class_stammering_information_title_container">
                ...
                <ul className="class_stammering_information_types">
                    ...
                    <li><i className="fas fa-circle"/>&nbsp;&nbsp;<span className="class_stammering_list">Grupo de ayuda para padres (G.A.P)</span>: El grupo de ayuda para padres es un espacio derivado a los mismos para informar y brindar herramientas acerca de la tartamudez hacia sus hijos, dándoles consejos sobre la tartamudez en sus hijos.</li>
                </ul>
